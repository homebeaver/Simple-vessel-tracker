...
public class ShipTypeCargo implements Serializable {
    ...
    public ShipTypeCargo(int intShipType) {
        ...
        if (firstDigit == 3) {
            switch (secondDigit) {
            case 0:
                shipTypeTmp = ShipType.FISHING; // 30
                break;
            case 1:
                shipTypeTmp = ShipType.TOWING; // 31 de: Schlepper
                break;
            case 2:
                shipTypeTmp = ShipType.TOWING_LONG_WIDE; // 32 length of the tow exceeds 200 m or breadth exceeds 25 m
                break;
            case 3:
                shipTypeTmp = ShipType.DREDGING; // 33 de: Bagger
                break;
            case 4:
                shipTypeTmp = ShipType.DIVING; // 34
                break;
            case 5:
                shipTypeTmp = ShipType.MILITARY; // 35
                break;
            case 6:
                shipTypeTmp = ShipType.SAILING; // 36
                break;
            case 7:
                shipTypeTmp = ShipType.PLEASURE; // 37
                break;
            case 8:
        ...
        if (firstDigit == 5) {
            switch (secondDigit) {
            case 0:
                shipTypeTmp = ShipType.PILOT; // 50 Pilot vessel
                break;
            case 1:
                shipTypeTmp = ShipType.SAR; // 51 Search and rescue vessel
                break;
            case 2:
                shipTypeTmp = ShipType.TUG; // 52 de: Bugsierschlepper
                break;
            case 3:
                shipTypeTmp = ShipType.PORT_TENDER; // 53 Port tenders
                break;
            case 4:
                shipTypeTmp = ShipType.ANTI_POLLUTION; // 54 Vessels with anti-pollution facilities or equipment
                break;
            case 5:
                shipTypeTmp = ShipType.LAW_ENFORCEMENT; // 55 Law enforcement vessels
                break;
            case 6:
                shipTypeTmp = ShipType.UNKNOWN;
            ...
            case 8:
                ...
                break; // 58 Medical transports (as defined in the 1949 Geneva Conventions and Additional Protocols)
            case 9:
                shipTypeTmp = ShipType.SHIPS_ACCORDING_TO_RR;
                break; // 59 Ships according to RR Resolution No. 18 (Mob-83)
            }
        }
