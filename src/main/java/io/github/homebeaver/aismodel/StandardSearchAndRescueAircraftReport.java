...
/**
 * StandardSearchAndRescueAircraftReport Message ID 9
 * <p>
 ...
 * Stations other than aircraft involved in SAR operations should not transmit this message. 
 * The default reporting interval for this message should be 10 s.
 */
...
public class StandardSearchAndRescueAircraftReport extends AisMessage {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getMessageID(), standardSearchAndRescueAircraftReport.getMessageID()) &&
  ...
  public int hashCode() {
	...
	altitude, sog, positionAccuracy, longitude, latitude, cog, timestamp, altFromBaro, spare1, dte, spare2, assignedMode, raim, communicationStateIsItdma, communicationState);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
	...
	public static StandardSearchAndRescueAircraftReport fromJson(JSONObject jo) {
		AisMessage res = new StandardSearchAndRescueAircraftReport();
		StandardSearchAndRescueAircraftReport sdr = null;
		...
		try {
			...
			sdr = (StandardSearchAndRescueAircraftReport) res;
			sdr = sdr.altitude(jo.getInt(SERIALIZED_NAME_ALTITUDE));
			sdr = sdr.sog(jo.getDouble(SERIALIZED_NAME_SOG));
			sdr = sdr.positionAccuracy(jo.getBoolean(SERIALIZED_NAME_POSITION_ACCURACY));
			sdr = sdr.longitude(jo.getDouble(SERIALIZED_NAME_LONGITUDE));
			sdr = sdr.latitude(jo.getDouble(SERIALIZED_NAME_LATITUDE));
			sdr = sdr.cog(jo.getDouble(SERIALIZED_NAME_COG));
			sdr = sdr.timestamp(jo.getInt(SERIALIZED_NAME_TIMESTAMP));
			sdr = sdr.altFromBaro(jo.getBoolean(SERIALIZED_NAME_ALT_FROM_BARO));
			// spare1
			sdr = sdr.dte(jo.getBoolean(SERIALIZED_NAME_DTE));
			// spare1
			sdr = sdr.assignedMode(jo.getBoolean(SERIALIZED_NAME_ASSIGNED_MODE));
