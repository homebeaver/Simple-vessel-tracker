...
/**
 * GnssBroadcastBinaryMessage Message ID 17
 */
...
public class GnssBroadcastBinaryMessage extends AisMessage {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getMessageID(), gnssBroadcastBinaryMessage.getMessageID()) &&
  ...
  public int hashCode() {
    ...
    spare1, longitude, latitude, spare2, data);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
	...
	public static GnssBroadcastBinaryMessage fromJson(JSONObject jo) {
		AisMessage res = new GnssBroadcastBinaryMessage();
		GnssBroadcastBinaryMessage msg = null;
		...
		try {
			...
			msg = (GnssBroadcastBinaryMessage) res;
			msg = msg.spare1(jo.getInt(SERIALIZED_NAME_SPARE1));
