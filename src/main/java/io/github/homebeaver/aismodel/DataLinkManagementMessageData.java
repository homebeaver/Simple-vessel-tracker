...
public class DataLinkManagementMessageData {
  ...
  public DataLinkManagementMessageData _0(DataLinkManagementMessageData0 _0) {
  ...
  **/
  ...
  public void set0(DataLinkManagementMessageData0 _0) {
    this._0 = _0;
  }


  public DataLinkManagementMessageData _1(DataLinkManagementMessageData0 _1) {
  ...
  **/
  ...
  public void set1(DataLinkManagementMessageData0 _1) {
    this._1 = _1;
  }


  public DataLinkManagementMessageData _2(DataLinkManagementMessageData0 _2) {
  ...
  **/
  ...
  public void set2(DataLinkManagementMessageData0 _2) {
    this._2 = _2;
  }


  public DataLinkManagementMessageData _3(DataLinkManagementMessageData0 _3) {
  ...
  **/
  ...
  public void set3(DataLinkManagementMessageData0 _3) {
    this._3 = _3;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DataLinkManagementMessageData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DataLinkManagementMessageData.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataLinkManagementMessageData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataLinkManagementMessageData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.getAsJsonObject("0") != null) {
        DataLinkManagementMessageData0.validateJsonObject(jsonObj.getAsJsonObject("0"));
      }
      // validate the optional field `1`
      if (jsonObj.getAsJsonObject("1") != null) {
        DataLinkManagementMessageData0.validateJsonObject(jsonObj.getAsJsonObject("1"));
      }
      // validate the optional field `2`
      if (jsonObj.getAsJsonObject("2") != null) {
        DataLinkManagementMessageData0.validateJsonObject(jsonObj.getAsJsonObject("2"));
      }
      // validate the optional field `3`
      if (jsonObj.getAsJsonObject("3") != null) {
        DataLinkManagementMessageData0.validateJsonObject(jsonObj.getAsJsonObject("3"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
	...
	public static DataLinkManagementMessageData fromJson(JSONObject jo) {
		DataLinkManagementMessageData res = new DataLinkManagementMessageData();
		...
		try {
			...
			JSONObject _2 = jo.getJSONObject(SERIALIZED_NAME_2);
			JSONObject _3 = jo.getJSONObject(SERIALIZED_NAME_3);
			res = res._0(DataLinkManagementMessageData0.fromJson(_0))
			._1(DataLinkManagementMessageData0.fromJson(_1))
			._2(DataLinkManagementMessageData0.fromJson(_2))
			._3(DataLinkManagementMessageData0.fromJson(_3));
		} catch (JSONException e) {
//	    	logger.error("Error creating DataLinkManagementMessageData", e);
			System.out.println("Error creating DataLinkManagementMessageData " + e);
		}
		return res;
	}
