...
/**
 * StaticDataReportReportA as defined by ITU-R M.1371-4
 */
...
public class StaticDataReportReportA {
  ...
  **/
  ...
  public StaticDataReportReportA name(String name) {
   ...
   /**
   * Get name
 Name of the MMSI-registered vessel. Maximum 20 characters 6-bit  ASCII, @@@@@@@@@@@@@@@@@@@@ = not available = default.
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
	...
	public static StaticDataReportReportA fromJson(JSONObject jo) {
		StaticDataReportReportA res = new StaticDataReportReportA();
		// Extract individual fields from JSONObject
		try {
			res = res.valid(jo.getBoolean(SERIALIZED_NAME_VALID))
			.name(jo.getString(SERIALIZED_NAME_NAME));
		} catch (JSONException e) {
//	    	logger.error("Error creating StaticDataReportReportA", e);
