...
/*
{"Message":{"UnknownMessage":{}},"MessageType":"UnknownMessage"
,"MetaData":{"MMSI":3669962,"MMSI_String":3669962,"ShipName":"","latitude":44.255833333333335,"longitude":-76.00333333333333,"time_utc":"2025-10-30 20:13:33.627445053 +0000 UTC"}}

 */
	public static UnknownMessage fromJson(JSONObject jo) {
		UnknownMessage um = new UnknownMessage();
		try {
			um = um.error(jo.getString(SERIALIZED_NAME_ERROR));
			System.out.println(um); // with error
		} catch (JSONException e) {
//			logger.error("Error creating UnknownMessage", e);
//			System.out.println("Error creating UnknownMessage " + e); // no error
