...
/**
 * StaticDataReportReportB as defined by ITU-R M.1371-4
 */
 ...
 */
	public static StaticDataReportReportB fromJson(JSONObject jo) {
		StaticDataReportReportB res = new StaticDataReportReportB();
		...
		try {
			...
			.shipType(jo.getInt(SERIALIZED_NAME_SHIP_TYPE))
			.vendorIDName(jo.getString(SERIALIZED_NAME_VENDOR_I_D_NAME))
			.venderIDModel(jo.getInt(SERIALIZED_NAME_VENDER_I_D_MODEL))
			.venderIDSerial(jo.getInt(SERIALIZED_NAME_VENDER_I_D_SERIAL))
			.callSign(jo.getString(SERIALIZED_NAME_CALL_SIGN))
			.dimension(ShipStaticDataDimension.fromJson(dimensions))
