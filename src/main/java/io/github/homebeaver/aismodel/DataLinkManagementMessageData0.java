...
public class DataLinkManagementMessageData0 {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
	...
	public static DataLinkManagementMessageData0 fromJson(JSONObject jo) {
		DataLinkManagementMessageData0 res = new DataLinkManagementMessageData0();
		...
		try {
			...
			.integerOfSlots(jo.getInt(SERIALIZED_NAME_INTEGER_OF_SLOTS))
			.timeOut(jo.getInt(SERIALIZED_NAME_TIME_OUT))
			.increment(jo.getInt(SERIALIZED_NAME_INCREMENT));
		} catch (JSONException e) {
//	    	logger.error("Error creating DataLinkManagementMessageData0", e);
			System.out.println("Error creating DataLinkManagementMessageData0 " + e);
		}
		return res;
	}
