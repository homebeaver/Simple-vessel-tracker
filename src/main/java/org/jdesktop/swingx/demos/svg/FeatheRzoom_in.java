 ...
 */
public class FeatheRzoom_in implements RadianceIcon {
...
shape = new Ellipse2D.Double(3.0, 3.0, 16.0, 16.0);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(21.000000f,21.000000f,16.650000f,16.650000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(11.000000f,8.000000f,11.000000f,14.000000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(8.000000f,11.000000f,14.000000f,11.000000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       FeatheRzoom_in base = new FeatheRzoom_in();
       base.width = width;
       base.height = height;
       return base;
    }
