...
public class FeatheRnavigation_grey implements RadianceIcon {
    ...
    private RadianceIcon.ColorFilter colorFilter = null; // filter for fill
    private RadianceIcon.ColorFilter colorFilterStroke = null;
...
shape = generalPath;
paint = (colorFilter != null) ? colorFilter.filter(new Color(211, 211, 211, 255)) : new Color(211, 211, 211, 255);
g.setPaint(paint);
g.fill(shape);
paint = (colorFilterStroke != null) ? colorFilterStroke.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
